...
type Config struct {
	...
	DefaultURI          string `yaml:"defaultURI,omitempty" envconfig:"DEFAULT_URI"  default:"http://localhost:8080"`
	...
	WebServerURI        string `yaml:"webServerURI,omitempty" envconfig:"WEB_SERVER_URI"  default:":8080"`
